...
from MindMedia.post_element import Post_element
# use the above import if in the other directory!
# from src.post_element import Post_element
from MindMedia.DBoperations import fetch_user_posts,fetch_friends
from MindMedia.widgets.Custom_Scrollable_Frame_widget import ScrollableFrame
...
class Feed_page(Frame):
    ...
    def on_create_post_clicked(self):
        ...
        Create_post_dialog(self.pop_up,current_user()).pack()
        self.pop_up.mainloop()
        # self.pop_up.grab_release()

# root=Tk()
# Feed_page(root,'alice@gmail.com').pack()
# Feed_page(root,'rick@gmail.com').pack()
# finish up ths GUI and finish the whole damn project!
# root.mainloop()
